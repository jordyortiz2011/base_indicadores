...
$config['levels_and_roles'] = array (
	'1' => 'visitante',		//usuario provicional, sin muchos privilegios
	'6' => 'registrador', 	//registrar� datos y actualizar�
	'8' => 'admin_reportes',  //ver� solo los reportes
	'9' => 'admin'		//control general
);
...
*/
$config['groups'] = array(
	'employees' => 'registrador,admin_reportes, admin'
);
...
|  TRUE= NO HAY MULTISESSEION
|  FALSE= si hay multisession
*/
