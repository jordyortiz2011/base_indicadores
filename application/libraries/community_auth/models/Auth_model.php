...
class Auth_model extends MY_Model {
	...
	public function clear_expired_holds()
	{
		...
		$this->db->delete( $this->db_table('IP_hold_table'), array('time <' => $expiration) );

		$this->db->delete( $this->db_table('username_or_email_hold_table'), array('time <' => $expiration) );
	}
	...
	public function clear_login_errors()
	{
		...
		$this->db->delete( $this->db_table('errors_table'), array('time <' => $expiration) );
	}
